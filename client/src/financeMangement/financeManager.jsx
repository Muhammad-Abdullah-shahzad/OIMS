...
const validatePaymentForm = (formData) => {
  ...
  if (
    ...
    errors.paidAmount =
      "Valid Paid Amount is required and must be a positive number.";
  }
...
const validateSalaryForm = (formData) => {
  ...
  if (
    ...
    isNaN(new Date(formData.payment_date).getTime())
  ) {
...
export default function FinanceManager() {
  ...
  const [paymentFilter, setPaymentFilter] = useState("All"); // State variable to handel filtering of payments
  ...
  const fetchPayments = useCallback(async () => {
    ...
    try {
      ...
      if (Array.isArray(result)) {
        ...
        throw new Error(
          result.message || "Unexpected data format from payment API."
        );
      }
    } catch (err) {
  ...
  const fetchClients = useCallback(async () => {
    ...
    try {
      ...
      if (result.success && Array.isArray(result.data)) {
        ...
        throw new Error(
          result.message || "Unexpected data format from client API."
        );
      }
    } catch (err) {
      if (err.hasOwnProperty("tokenVerified")) {
  ...
  const fetchExpenses = useCallback(async () => {
    ...
    try {
      ...
      if (result.success && Array.isArray(result.expenses)) {
        ...
        throw new Error(
          result.message || "Unexpected data format from expense API."
        );
      }
    } catch (err) {
      if (err.hasOwnProperty("tokenVerified")) {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      if (result.success && Array.isArray(result.data)) {
        ...
        throw new Error(
          result.message || "Unexpected data format from user API."
        );
      }
    } catch (err) {
      if (err.hasOwnProperty("tokenVerified")) {
  ...
  const fetchSalaryPayments = useCallback(async () => {
    ...
    try {
      ...
      if (result.success && Array.isArray(result.data)) {
        ...
        throw new Error(
          result.message || "Unexpected data format from salary API."
        );
      }
    } catch (err) {
      if (err.hasOwnProperty("tokenVerified")) {
  ...
  const openModal = (mode, item = null) => {
    ...
    } else if (mode.includes("salary")) {
      // New: Salary related modals
    ...
    } else if (mode === "export_pdf_dates") {
      // For Expense PDF export date selection
    ...
    } else if (mode === "export_salary_pdf") {
      // New: For Salary PDF export selection
      setSalaryReportData({
        id: "",
  ...
  const closeModal = () => {
    ...
    setSalaryReportData({
      // Clear salary report data on close
      id: "",
      month: new Date().getMonth() + 1,
      year: new Date().getFullYear(),
    });
  ...
  const handlePaymentSubmit = async (e) => {
    ...
    try {
      ...
      showToastMessage(
        `Payment ${
          modalMode === "create_payment" ? "added" : "updated"
        } successfully!`,
        "success"
      );
      closeModal();
  ...
  const handleExpenseSubmit = async (e) => {
    ...
    try {
      ...
      showToastMessage(
        `Expense ${
          modalMode === "create_expense" ? "added" : "updated"
        } successfully!`,
        "success"
      );
      closeModal();
  ...
  const handleSalarySubmit = async (e) => {
    ...
    try {
      ...
      showToastMessage(
        `Salary payment ${
          modalMode === "create_salary" ? "added" : "updated"
        } successfully!`,
        "success"
      );
      closeModal();
  ...
  const handleExportPdf = async (e) => {
    ...
    try {
      const token = localStorage.token;
      const response = await fetch(
        `${API_BASE_URL}/expense/get-report/${startDate}/${endDate}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const renderModalContent = () => {
    ...
    const isNarrowFormModal =
      modalMode === "create_payment" ||
      modalMode === "edit_payment" ||
      modalMode === "create_expense" ||
      modalMode === "edit_expense" ||
      modalMode === "create_salary" ||
      modalMode === "edit_salary" ||
      modalMode === "export_pdf_dates" ||
      modalMode === "export_salary_pdf"; // New: include salary PDF export form
    const modalContentClasses = `modal-content animate-scaleIn ${
      isNarrowFormModal ? "modal-content-form-narrow" : ""
    }`;
              ...
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <select
                    ...
                    className={`form-select ${
                      validationErrors.project_id ? "input-error" : ""
                    }`}
                    required
                  >
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={handlePaymentChange}
                    className={`form-select ${
                      validationErrors.client_id ? "input-error" : ""
                    }`}
                    required
                  >
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`form-input ${
                      validationErrors.paidAmount ? "input-error" : ""
                    }`}
                    required
                    step="0.01"
                    min="0"
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handlePaymentChange}
                    className={`form-input ${
                      validationErrors.payment_date ? "input-error" : ""
                    }`}
                    required
                  />
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={handlePaymentChange}
                    className={`form-select ${
                      validationErrors.payment_method ? "input-error" : ""
                    }`}
                    required
                  >
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="invoiceFile"
                    name="invoice_file"
                    value={paymentFormData.invoice_file}
                    onChange={handlePaymentChange}
                    className="form-input"
                  />
                </div>
            ...
            <div className="delete-modal-content">
              ...
              <p className="modal-text">
                ...
                <span className="project-title-display">
                  "{getProjectTitle(selectedPayment?.project_id)}"
                </span>{" "}
                (ID: {selectedPayment?.id})? This action cannot be undone.
              </p>
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleExpenseChange}
                    className={`form-input ${
                      validationErrors.expense_date ? "input-error" : ""
                    }`}
                    required
                  />
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="receiptFile"
                    name="receipt_file"
                    value={expenseFormData.receipt_file}
                    onChange={handleExpenseChange}
                    className="form-input"
                  />
                </div>
                <div className="form-group">
                  ...
                  <select
                    id="approvedBy"
                    name="approved_by"
                    value={expenseFormData.approved_by}
                    onChange={handleExpenseChange}
                    className="form-select"
                  >
          ...
          <div className={modalContentClasses}>
            ...
            <div className="delete-modal-content">
              ...
              <p className="modal-text">
                ...
                (ID: {selectedExpense?.id})? This action cannot be undone.
              </p>
              <div className="modal-actions">
                <button
                  type="button"
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    className={`form-select ${
                      validationErrors.employee_id ? "input-error" : ""
                    }`}
                    required
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={handleSalaryChange}
                    className={`form-select ${
                      validationErrors.salary_month ? "input-error" : ""
                    }`}
                    required
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleSalaryChange}
                    className={`form-input ${
                      validationErrors.salary_year ? "input-error" : ""
                    }`}
                    required
                ...
                {/* Reference Number */}
                <div className="form-group">
                  <label htmlFor="salaryReferenceNumber">
            ...
            <div className="delete-modal-content">
              ...
              <p className="modal-text">
                ...
                <span className="employee-name">
                  {selectedSalaryPayment?.employee_name}
                </span>{" "}
                (ID: {selectedSalaryPayment?.system_employee_id}) for{" "}
                <span className="payment-period">
                  {getMonthName(selectedSalaryPayment?.salary_month)}{" "}
                  {selectedSalaryPayment?.salary_year}
                </span>
              ...
              <div className="form-grid">
                <div className="form-group form-group-full">
                  ...
                  <select
                    ...
                    className={`form-select ${
                      validationErrors.id ? "input-error" : ""
                    }`}
                    required
                  >
                    <option value="">Select an Employee</option>
                  ...
                  {validationErrors.id && (
                    <p className="error-message">{validationErrors.id}</p>
                  )}
                </div>
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={handleSalaryReportDataChange}
                    className={`form-select ${
                      validationErrors.month ? "input-error" : ""
                    }`}
                    required
                  >
                    <option value="">Select Month</option>
                  ...
                  {validationErrors.month && (
                    <p className="error-message">{validationErrors.month}</p>
                  )}
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleSalaryReportDataChange}
                    className={`form-input ${
                      validationErrors.year ? "input-error" : ""
                    }`}
                    required
                    min="2000" // Adjust as needed
                    max={new Date().getFullYear() + 5} // Adjust as needed
                  ...
                  {validationErrors.year && (
                    <p className="error-message">{validationErrors.year}</p>
                  )}
                </div>
              </div>
              <div className="form-actions">
  ...
  return (
    <div className="finance-management-container">
            ...
            <tbody>
              {expenses.map((expense) => (
                ...
                >
                  ...
                  <td className="table-data">
                    {getUserName(expense.approved_by)}
                  </td>{" "}
                  {/* Display user's name */}
                  <td className="table-data table-actions">
                    <div className="action-buttons-group">
      ...
      !loading &&
      !error &&
      !modalMode.includes("salary") ? (
        <div className="no-data-found">
          <p>
            No salary records found. Click "Record New Salary Payment" to get
            started!
          </p>
        </div>
      ) : (
            ...
            <tbody>
              {salaryPayments.map((payment) => (
                <tr key={payment.id} className="table-row">
                  ...
                  {/* Assuming designation might not be in salary API */}
                  <td className="table-data">
                    {getMonthName(payment.salary_month)} {payment.salary_year}
                  </td>
                  <td className="table-data">
      ...
      {/* Modal Overlay */}
      {showModal && <div className="modal-overlay">{renderModalContent()}</div>}
    </div>
  );
}
